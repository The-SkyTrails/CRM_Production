...
class CompanyCourierDetailsForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['company_name', 'address', 'landmark', 'city', 'state', 'zipcode', 'docker_no', 'courier_no', 'status']
        ...
        widgets = {
                ...
                'zipcode':forms.NumberInput(attrs={'class':'form-control','placeholder':'Enter Zipcode'}),
                'docker_no':forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Docker No'}),
                'courier_no':forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Number'}),
...
class ReceiverDetailsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'sender_no':forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Number'}),
            'receiver_no':forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Number'}),
            'receiver_address':forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Address'}),
            'sender_address':forms.TextInput(attrs={'class':'form-control','placeholder':'Enter Address'}),
        }
...
class EmployeeDetailsForm1(forms.ModelForm):
    ...
    class Meta:
        model = Employee
        fields = ['department', 'branch', 'group', 'contact_no','first_name','last_name']

        widgets = {
            'department': forms.Select(attrs={'class': 'form-control'}),
            'branch': forms.Select(attrs={'class': 'form-control'}),
            'group': forms.Select(attrs={'class': 'form-control'}),
            'contact_no': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Enter Number'}),
...
class EmployeeDetailsForm2(forms.ModelForm):
    email = forms.EmailField(max_length=30, required=True, widget=forms.EmailInput(attrs={'class': 'form-control', 'placeholder': 'Enter Email'}))
