...
urlpatterns = [
    ...
    path("VisaCountry/Delete/<int:id>", delete_visa_country, name="delete_visa_country"),
    ...
    path("DocumentCategory/Edit/",documentcategoryupdate_view,name="documentcategoryupdate_view"),
    path("deletedocumentcategory/<int:id>/",delete_documentcategory,name="delete_documentcategory"),
    ...
    path("update_company_details/<int:id>/",UpdateCompanyDetailsView.as_view(),name="update_company_details"),
    ...
    path("Agent/Agreement/update/<int:id>/",admin_agent_agreement_update,name="update_agreement"),
    path("Agent/Agreement/Delete/<int:id>/",admin_agent_agreement_delete,name="admin_agent_agreement_delete",),
    ...
    path("OutSourceAgent/Details/<int:id>",admin_outsourceagent_details,name="admin_outsourceagent_details"),
    path("OutSourceAgent/Agreement/<int:id>",admin_outsource_agent_agreement,name="admin_outsource_agent_agreement"),
    path("OutSource/Agent/Kyc/<int:id>",admin_outsource_agent_kyc,name="admin_outsource_agent_kyc"),
    path("Outsourceagent_delete/<int:id>/", outstsourceagent_delete, name="outstsourceagent_delete"),
