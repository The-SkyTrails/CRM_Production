...
def admin_agent_kyc(request, id):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            kyc_id = None
            kyc = AgentKyc.objects.create(agent=agent,adhar_card_front=adharfront_file,adhar_card_back=adharback_file,pancard=pan_file,registration_certificate=registration_file)
            kyc.save()
            messages.success(request,'Kyc Added Successfully..')
            return redirect('admin_agent_kyc',id)
...
def admin_outsource_agent_kyc(request, id):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            kyc_id = None
            kyc = AgentKyc.objects.create(outsourceagent=outsourceagent,adhar_card_front=adharfront_file,adhar_card_back=adharback_file,pancard=pan_file,registration_certificate=registration_file)
            kyc.save()
            messages.success(request,'Kyc Added Successfully..')
            return redirect('admin_outsource_agent_kyc',id)
